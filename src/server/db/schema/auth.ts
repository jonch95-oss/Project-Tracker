/**
 * Tables owned by Better Auth (core + twoFactor + passkey plugins).
 * Field names match Better Auth's model fields; `role` and `status` on
 * `user` are our additional fields.
 */
